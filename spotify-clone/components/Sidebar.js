...
function sidebar() {
    ...
    return (
        <div className='text-gray-500 p-5 text-sm border-r border-gray-900 overflow-y-scroll scrollbar-hide h-screen lg:text-xm sm:max-w-[12rem] lg:max-w-[15rem] hidden md:inline-flex pb-36'>
